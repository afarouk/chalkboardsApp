...
//    printf("\n\n Superview %s",[NSStringFromClass([[self superview] class]) UTF8String]);
}
...
@synthesize cellObj, asyncImageViewType;
...
//    switch (asyncImageViewType) {
//        case AsyncImageViewTypeTileImage:{
//            CGSize cellSize = [self sizeForRowIfImageDownloaded:image];
////            CTTileViewCell *cell = cellObj;
//            if(CGSizeEqualToSize(cellSize, CGSizeZero) == NO)
//                [((CTTileViewCell *) cellObj) tileImageView].frame = CGRectMake(0, 0, cellSize.width, cellSize.height);
//            //                    [cell.contentView addSubview:imageView];
//            [[((CTTileViewCell *) cellObj) tileImageView] setImage:image];
//            @try {
//                UITableView * tbl = [((CTTileViewCell *) cellObj) parentTableView];
//                [tbl beginUpdates];
//                [((CTTileViewCell *) cellObj) setNeedsLayout];
//                [tbl endUpdates];
//            }
